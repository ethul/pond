...
exports.default = {
    ...
    rangeFromIndexString: function rangeFromIndexString(index, utc) {
        ...
        switch (parts.length) {
            case 3:
                var isoWeekRegex = /^W(\d\d)$/;
                var isoWeek = isoWeekRegex.exec(parts[1]);
                // A year, a week, a week day e.g., 2020-W11-3
                if (isoWeek) {
                    var beginIndex = parts[0] + "-W" + isoWeek[1] + "-1";
                    var endIndex = parts[0] + "-W" + isoWeek[1] + "-7";
                    beginTime = isUTC ? _moment2.default.utc(beginIndex) : (0, _moment2.default)(beginIndex);
                    endTime = isUTC ? _moment2.default.utc(endIndex).endOf("day") : (0, _moment2.default)(endIndex).endOf("day");
                }
                // A day, month and year e.g. 2014-10-24
                else if (!_underscore2.default.isNaN(parseInt(parts[0], 10)) && !_underscore2.default.isNaN(parseInt(parts[1], 10)) && !_underscore2.default.isNaN(parseInt(parts[2], 10))) {
